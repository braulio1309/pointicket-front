            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="testimonial-heading-area">
                        <SectionTitle preTitle='Testimonios' preTitleClass='pre-textsecondary'
                            title='Que opinan de nuestro sistema de entradas'
                ...
                <div class="col-lg-7">
                    <div>
                        <swiper 
                            class="testimonial-activation-3" 
                            :modules="modules" 
                            :slidesPerView="1" 
                            :loop="true" 
                            :spaceBetween="0"
                            ...
                            <swiper-slide>
                                <div class="testimonial-grid testimonial-style-3">
                                    ...
                                    <div class="content">
                                        <p>Lorem ipsum dolor amet consec tur elit adicing sed do usmod zx tempor enim
