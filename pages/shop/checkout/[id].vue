                            ...
                            <div class="order-payment">
                                <div class="row justify-content-center">
                                    ...
                                    <stripe-checkout ref="checkoutRef" mode="payment" :pk="publishableKey"
                                        ...
                                        :cancel-url="'https://pointickets.com'" @loading="v => loading = v" />
...
export default {
    ...
    methods: {
        ...
        async getEvent() {
            ...
            this.lineItems = [{
                price: this.ticket.attributes.price_id_production,
                quantity: 1,
            }];
        },
        async verifyCoupon() {
    ...
    async mounted() {
        ...
        if (window.localStorage.getItem('jwt') == null) {
            ...
            await this.getEvent();
            this.userData();
            if (this.ticket.attributes.type === 'Física' || this.ticket.attributes.type === 'Papel') {
                this.feeEnvio = 10
            }
